...
With these three rules together in a makefile, `make counties.json` will perform the necessary steps to produce a U.S. Counties TopoJSON file from scratch.
