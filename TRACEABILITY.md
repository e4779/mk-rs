...
| F-063 | Backquote command substitution in mkfile | `lex`, `var` | 1b |
...
| F-057 | `$OBJ` / `$O` (Plan 9 arch-dependent objects) | — | P3/deferred |
| F-070 | `membername` utility | — | P3/deferred |

## Summary by phase

| Phase | Feature count | What it covers |
|-------|:---:|---|
| **1a** | 22 | Parser, basic DAG, serial exec with sh, core variables, V/N/Q attrs, -f/-n/-e/-t/-a |
| **1b** | 12 | Include `< file`, prereq/target vars, missing intermediates, E/U attrs, -k/-i/-t flags |
| **2** | 22 | %/&/R metarules, transitive closure, pruning, NPROC parallel, $stem/$newprereq, namelists |
| **3** | 10 | Aggregates, `<| cmd`, P attribute, dynamic mkfile, -d debug, polish |
| **P3/deferred** | 4 | Plan 9 specifics ($O, membername), dynamic stdout-as-mkfile |
